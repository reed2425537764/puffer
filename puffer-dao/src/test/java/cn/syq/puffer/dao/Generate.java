...
public class Generate {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Generate.class.getResource("/").getPath().substring(1).replace("/target/test-classes/",""));
    }
    @Test
    public void generate() {
        ...
        gc.setOutputDir(Generate.class.getResource("/").getPath().substring(1).replace("/target/test-classes/","") + "/src/main/java");      //生成文件的输出目录
        gc.setAuthor("shiyuqin");                                  //作者
...
// 数据源配置
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/puffer?useUnicode=true&useSSL=false&characterEncoding=utf8");
// dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("971214");
...
//      pc.setParent("com.stu");
        //自定义包配置
        pc.setParent("cn.syq.puffer.dao.sql");
